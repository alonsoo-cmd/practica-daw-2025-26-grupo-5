...
public class DataBaseInitializer {
    ...
    public void init() throws IOException, URISyntaxException {
        ...
        Product product2 = new Product("iPhone 17 Pro", "tech", 1399, "The latest Apple smartphone, equipped with advanced AI-powered features, a next-generation professional camera system, and outstanding performance for everyday and professional use.", "sold", user, "Calle de Velazquez 45, 28001 Madrid");
        Product product3 = new Product("Dell XPS 15 Laptop", "tech", 1899, "High-performance Dell XPS 15 laptop with a stunning 4K display, elegant design, and powerful hardware ideal for demanding tasks such as editing, development, and creative work.", "sold", user, "Calle de Alcala 120, 28009 Madrid");
        Product product4 = new Product("Leather Winter Coat", "fashion", 349, "Premium black leather winter coat designed to deliver elegance, durability, and excellent protection against cold weather during the winter season.", "sold", user, "Avenida de America 23, 28002 Madrid");
